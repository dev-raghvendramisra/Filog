...
function PostCont({
  ...
  return (
    ...
    {type=="dashboard"?
    <div id='tag-container' className='h-fit flex text-1vw text-darkPrimary_grays dark:text-white dark:text-opacity-70 text-opacity-80 flex-start gap-3'>
      <button onClick={handleClick} ref={refs[0]} id='featured-blogs' className='px-1.5vw py-0.5vw rounded-full'>
        <i className='fa-solid fa-bolt mr-0.5vw'></i>
        Featured
      </button>
      <button onClick={handleClick} ref={refs[1]} id='following-blogs' className='px-1.5vw py-0.5vw rounded-full'>
