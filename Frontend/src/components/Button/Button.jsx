...
function Button({children="Button",onClick=()=>{},className='',wide=false,disabled=false,type='',primary=false,danger=false,outline=false,loading=false,...props}) {
  console.log("handler from button: ",onClick);
