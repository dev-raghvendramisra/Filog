        ...
        <div className="lg:flex lg:gap-12 relative">
          <div className="lg:flex-1">
            ...
            <PrivacySection id="information-collection" title="Information We Collect">
              <h3 className="text-gray-800 dark:text-gray-50 font-semibold text-xl mb-4">Personal Information You Provide</h3>
              <p className="text-gray-800 dark:text-gray-50">
                We may collect personal information that you voluntarily provide to us when you:
              </p>
              <ul className="list-disc pl-5 mb-6 text-gray-800 dark:text-gray-50">
              ...
              <h3 className="text-gray-800 dark:text-gray-50 font-semibold text-xl mb-4">Information Collected Automatically</h3>
              <p className="text-gray-800 dark:text-gray-50">
                When you access our services, we may automatically collect certain information about your device, including:
              </p>
              <ul className="list-disc pl-5 text-gray-800 dark:text-gray-50">
                <li>IP address</li>
            ...
            <PrivacySection id="information-use" title="How We Use Your Information">
              <p className="text-gray-800 dark:text-gray-50">We use the information we collect for various purposes, including to:</p>
              <ul className="text-gray-800 dark:text-gray-50">
            ...
            <PrivacySection id="information-sharing" title="Information Sharing and Disclosure">
              <p className="text-gray-800 dark:text-gray-50">We may share your information in the following circumstances:</p>
              
              <h3 className="text-gray-800 dark:text-gray-50">With Service Providers</h3>
              <p className="text-gray-800 dark:text-gray-50">
              ...
              <h3 className="text-gray-800 dark:text-gray-50">For Legal Reasons</h3>
              <p className="text-gray-800 dark:text-gray-50">
                We may disclose your information if required to do so by law or in response to valid requests by public authorities (e.g., a court or government agency).
              </p>
              
              <h3 className="text-gray-800 dark:text-gray-50">Business Transfers</h3>
              <p className="text-gray-800 dark:text-gray-50">
                If we are involved in a merger, acquisition, or sale of all or a portion of our assets, your information may be transferred as part of that transaction.
              </p>
              
              <h3 className="text-gray-800 dark:text-gray-50">With Your Consent</h3>
              <p className="text-gray-800 dark:text-gray-50">
            ...
            <PrivacySection id="cookies" title="Cookies and Similar Technologies">
              ...
              <p className="text-gray-800 dark:text-gray-50">We use the following types of cookies:</p>
              <ul className="text-gray-800 dark:text-gray-50">
            ...
            <PrivacySection id="user-rights" title="Your Rights and Choices">
              <p className="text-gray-800 dark:text-gray-50">Depending on your location, you may have certain rights regarding your personal information:</p>
            ...
            <PrivacySection id="contact" title="Contact Us">
              ...
              <p className="text-gray-800 dark:text-gray-50 my-4">
                Email: filogteam@gmail.com<br />
              </p>
              
              <div className="mt-8 p-6 bg-primary bg-opacity-10 rounded-lg border border-primary dark:border-primary_darkMode dark:border-opacity-70 border-opacity-20">
                <h3 className="text-lg font-semibold text-primary dark:text-primary_darkMode mb-3">Need More Help?</h3>
                ...
                <button className="px-4 py-2 bg-primary dark:bg-primary_darkMode text-white rounded-md hover:bg-primary_darkMode transition-colors">
